...
export const SuccessTost = ({ message , setFormStatus}: any) => {
  return (
    <div className="w-[65%] py-2 px-4 text-stone-500 bg-green-700 flex justify-between items-center gap-4">
        ...
        <RxCrossCircled onClick={()=>setFormStatus(false)} className="text-xl text-white cursor-pointer"/>
    </div>
  );
};
export const ErrorTost = ({ message , setFormStatus}: any) => {
  return (
